    ...
    <>
      ...
      <div className="px-6 sm:px-10 py-10">
        <div className="max-w-lg mx-auto flex flex-col sm:flex-row gap-4">
          <button className={cn('flex-1 px-8 py-4 rounded-xl font-bold text-sm transition-all duration-300 transform hover:scale-[1.03] flex items-center justify-center gap-2', style.button, style.buttonText)}>
            <Wallet className="w-4 h-4" /> Buy ${data.ticker || 'TOKEN'}
          </button>
          <button className={cn('flex-1 px-8 py-4 rounded-xl font-bold text-sm border transition-all duration-300 hover:bg-white/5 flex items-center justify-center gap-2', style.border, style.accent)}>
