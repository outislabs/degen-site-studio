...
const plans = [
  ...
  },
  {
    ...
    features: ['3 coin websites', 'Custom domain', 'No watermark', 'All templates', '50 meme downloads/mo', 'Analytics dashboard', 'API access'],
    cta: 'Go Degen',
    popular: true,
  },
  {
    ...
    features: ['10 coin websites', 'Full content studio', 'Unlimited downloads', 'Sticker pack builder', 'Analytics & API access', 'Priority support'],
    cta: 'Start Creating',
    popular: false,
  },
  {
    ...
    features: ['Unlimited websites', 'White label', 'Whale alerts', 'Everything in Creator'],
    cta: 'Go Whale',
    popular: false,
  },
];
