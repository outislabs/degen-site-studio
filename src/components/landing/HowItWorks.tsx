...
const HowItWorks = () => (
  <section className="px-6 py-20 relative">
    <div className="max-w-4xl mx-auto">
      ...
      <div className="relative flex flex-col gap-10 sm:gap-0 sm:flex-row sm:justify-between">
        {/* Connector line */}
        <div className="hidden sm:block absolute top-10 left-[15%] right-[15%] h-px bg-gradient-to-r from-transparent via-primary/20 to-transparent" />
        ...
        {steps.map((s, i) => (
          ...
          >
            <div className="w-20 h-20 rounded-2xl bg-primary/5 border border-primary/10 flex items-center justify-center mb-5 group-hover:border-primary/30 transition-colors">
