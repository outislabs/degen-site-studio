    ...
    <div className="overflow-x-auto my-4">
      <table className="w-full text-xs border border-border rounded-lg overflow-hidden">
        ...
        <tbody className="divide-y divide-border">
          ...
          <tr className="hover:bg-muted/30"><td className="px-4 py-2.5 text-primary font-medium">Degen</td><td className="px-4 py-2.5 text-muted-foreground">30</td><td className="px-4 py-2.5 text-muted-foreground">2,000</td><td className="px-4 py-2.5 text-muted-foreground">$8/mo</td></tr>
          <tr className="hover:bg-muted/30"><td className="px-4 py-2.5 text-primary font-medium">Creator</td><td className="px-4 py-2.5 text-muted-foreground">60</td><td className="px-4 py-2.5 text-muted-foreground">5,000</td><td className="px-4 py-2.5 text-muted-foreground">$29/mo</td></tr>
          <tr className="hover:bg-muted/30"><td className="px-4 py-2.5 text-primary font-medium">Whale</td><td className="px-4 py-2.5 text-muted-foreground">120</td><td className="px-4 py-2.5 text-muted-foreground">20,000</td><td className="px-4 py-2.5 text-muted-foreground">$75/mo</td></tr>
        </tbody>
      </table>
    </div>
    <P>
