...
export type LayoutStyle = 'classic' | 'split-hero' | 'bento' | 'minimal' | 'mascot-hero' | 'cinematic' | 'cartoon' | 'cartoon-sky' | 'comic-hero' | 'terminal' | 'neon-cyberpunk' | 'luxury' | 'retro-8bit' | 'newspaper' | 'minimalist';
